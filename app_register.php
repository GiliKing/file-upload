...
<head>
	...
	<title>File Upload | Register </title>
...
<form class="form-signin" method="POST">
 ...
 ?>
  ...
  <div class="form-label-group">
    <input type="text" id="inputName" class="form-control" name='username' autofocus>
  ...
  <span><small>Registered already? <a href='app_login.php'>Sign in instead</a></small></span>
